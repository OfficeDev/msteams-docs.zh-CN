...
>[!TIP]
> 查看 Teams 应用模板目录中的生产   [**就绪模板**](samples/app-templates.md)。 目录按字母顺序排序，最新添加内容用星形标记 **&#9734;。**
...
| 08/12/2020 |移动到 GA 的传入 Webhook 中的自适应卡片支持。|[使用传入 webhook 发送自适应卡](~/webhooks-and-connectors/how-to/connectors-using.md#send-adaptive-cards-using-an-incoming-webhook) |
...
| 06/20/2019 | 将外部网站从外部网站共享到 Teams 频道。 | [共享到 Teams](~/share-to-teams.md) |
...
| 11/12/2018 | 群聊中的选项卡现已在 Teams 的已发布版本中提供，并且已退出开发人员预览版。 作为此工作的一部分，为清楚起见，已对选项卡部分进行了修改。| [可配置的选项卡](~/concepts/tabs/tabs-configurable.md) |
...
| 05/29/2018 | 自适应卡片现在在 Teams 中的自适应 [卡片操作中受支持](task-modules-and-cards/cards/cards-reference.md)。 |
| 05/29/2018 | 如果你使用的是开发人员 [预览版](~/resources/dev-preview/developer-preview-intro.md)，则机器人现在可以发送和接收文件。| [通过自动程序（Microsoft](~/concepts/bots/bots-files.md)Teams 公共服务中的功能 [开发者预览版发送和接收文件](~/resources/dev-preview/developer-preview-features.md)|
| 04/17/2018 | replyToID 已添加到和卡 `Invoke` 操作 `MessageBack` 的有效负载中。 如果你需要更新卡片操作来自的消息，这尤其有用。 | [卡片操作](~/concepts/cards/cards-actions.md)|
