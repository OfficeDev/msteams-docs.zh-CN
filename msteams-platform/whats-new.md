...
|06/21/2021|使用自动程序卸载个人应用的行为。| 生成自动程序>聊天机器人>自动程序卸载 [个人应用中的行为更新](bots/how-to/conversations/subscribe-to-conversation-events.md#uninstall-behavior-for-personal-app-with-bot)|
