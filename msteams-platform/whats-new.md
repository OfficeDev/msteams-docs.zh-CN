...
|04/30/2021|有关如何将应用发布到应用商店的新Teams指南。|[将应用发布到 Teams 应用商店，Teams](concepts/deploy-and-publish/appsource/publish.md)[应用商店验证指南](concepts/deploy-and-publish/appsource/prepare/teams-store-validation-guidelines.md) |
...
| **日期** | **注释** | **已更改的主题** |
| -------- | --------- | ------------------ |
|11/30/2020|标识平台与选项卡Teams Toolkit和Visual Studio Code集成。|[使用选项卡的身份验证和Teams Toolkit Visual Studio Code单一登录身份验证](toolkit/visual-studio-code-tab-sso.md)|
...
|09/18/2020|支持会议Teams应用 (Release Preview) 。|[创建用于会议Teams](apps-in-teams-meetings/create-apps-for-teams-meetings.md)[应用和会议Teams应用](apps-in-teams-meetings/teams-apps-in-meetings.md)|
...
|07/27/2020 | Graph公共预览版中 (主动聊天机器人) 。|[使用 Microsoft Graph 在 Teams 中启用主动机器人安装和主动Graph](graph-api/proactive-bots-and-messages/graph-proactive-bots-and-messages.md)|
...
|07/01/2020|使用 Teams 开始构建Visual Studio Code Toolkit。|[使用应用和Microsoft Teams Toolkit生成Visual Studio Code](toolkit/visual-studio-code-overview.md) |
|07/01/2020|适用于 Web 和桌面客户端的选项卡 GA 的单一Teams登录。|[单Sign-On (SSO) ](tabs/how-to/authentication/auth-aad-sso.md)|
...
| 09/24/2018 | 适用于 Microsoft Graph 的通话和联机会议 API 已发布到 beta 版本，Teams现在可以使用语音和视频以丰富方式与用户进行交互。 | [通话和联机会议](~/concepts/calls-and-meetings/registering-calling-bot.md)机器人、[实时媒体](~/concepts/calls-and-meetings/real-time-media-concepts.md)概念、注册呼叫[](~/concepts/calls-and-meetings/registering-calling-bot.md)机器人、[调试和](~/concepts/calls-and-meetings/debugging-local-testing-calling-meeting-bots.md)本地测试、应用程序托管的[媒体](~/concepts/calls-and-meetings/requirements-considerations-application-hosted-media-bots.md)、[处理传入呼叫通知](~/concepts/calls-and-meetings/call-notifications.md) |
...
| 04/12/2018 | 添加了本主题以跟踪对编程Teams和本文档集的更改。 | [新增功能](~/whats-new.md)|
...
| **日期** | **注释** | **已更改的主题** |
| -------- | --------- | ------------------ |
|06/23/2021| 会议详细信息 API 和实时Teams会议事件。 | [创建适用于 Teams 会议的应用](~/apps-in-teams-meetings/create-apps-for-teams-meetings.md#meeting-details-api) |
...
|06/16/2021| 聊天的特定于资源的同意。 |[特定于资源的同意](graph-api/rsc/resource-specific-consent.md)，[测试](graph-api/rsc/test-resource-specific-consent.md)资源特定的许可权限Teams|
...
|05/25/2021| 新的开发人员门户Teams用于管理你的 Teams 应用。 | [Teams 开发人员门户](concepts/build-and-test/teams-developer-portal.md) |
|05/25/2021| 自定义一起模式场景功能将参与者合并到单个虚拟场景，并将其视频流放在预先确定的座位中。 | [自定义一起模式场景](~/apps-in-teams-meetings/teams-together-mode.md) |
|05/24/2021|自动程序可以使用 RSC (特定资源同意接收) 。|[使用 RSC、机器人](~/bots/how-to/conversations/channel-messages-with-rsc.md)对话[概述](~/bots/how-to/conversations/conversation-basics.md)、[频道和组对话](~/bots/how-to/conversations/channel-and-group-conversations.md)以及[开发人员预览](~/resources/schema/manifest-schema-dev-preview.md)清单架构接收所有消息 |
