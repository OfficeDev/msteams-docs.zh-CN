...
|09/18/2020|支持会议内应用Teams发布 (预览) 。|[创建用于Teams会议的应用](apps-in-teams-meetings/create-apps-for-teams-meetings.md)[和会议Teams应用](apps-in-teams-meetings/teams-apps-in-meetings.md)|
...
|07/01/2020|开始使用 Teams 生成Visual Studio Code Toolkit。|[使用 Microsoft Teams Toolkit 和 Visual Studio Code](toolkit/visual-studio-code-overview.md) |
...
| 04/12/2018 | 添加了本主题以跟踪对 Teams 接口和本文档集的更改。 | [新增功能](~/whats-new.md)|
