...
|08/25/2021| 引入了使用 SSO Teams单一登录创建自动 (分步) 。 | [使用 SSO 创建自动程序Teams分步指南](sbs-bots-with-sso.yml) |
...
|09/18/2020|支持会议内应用Teams发布 (预览) 。|[在会议Teams应用和应用](apps-in-teams-meetings/create-apps-for-teams-meetings.md)[Teams会议](apps-in-teams-meetings/teams-apps-in-meetings.md)|
...
|07/27/2020 | Graph公共预览版中 (主动聊天机器人) 。|[使用 Microsoft Graph 在 Teams 中启用主动自动程序安装和主动Graph](graph-api/proactive-bots-and-messages/graph-proactive-bots-and-messages.md)|
...
除了新功能之外，我们还提供[生产](samples/app-templates.md)就绪Teams模板，你可以立即部署这些模板或修改以满足你的需求。 新添加的模板用星号表示 。
