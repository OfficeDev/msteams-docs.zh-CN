...
| 日期 | 更新 | 在此处查找  |
| --- | --- | --- |
|12/20/2021 | 引入了链接到 SaaS 产品的应用指南。 | 将应用>发布到 Teams 应用商店>查看> [SaaS](concepts/deploy-and-publish/appsource/prepare/teams-store-validation-guidelines.md#apps-linked-to-saas-offer)产品/服务的应用指南|
