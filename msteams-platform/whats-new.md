...
>[!TIP]
> 查看 Teams 应用模板目录中的生产就绪   [**模板**](samples/app-templates.md)。 目录按字母顺序排序，最新添加内容用星形标记 **&#9734;。**
...
| "日期" | **备注** | **已更改的主题** |
| -------- | --------- | ------------------ |
|03/05/2021|注意：选项卡将不再具有围绕其体验的边距。 选项卡开发人员应查看和更新其应用。 | [删除选项卡边距](resources/removing-tab-margins.md) |
...
| 08/12/2020 |传入 Webhook 中的自适应卡片支持已移动到 GA。|[使用传入 webhook 发送自适应卡](~/webhooks-and-connectors/how-to/connectors-using.md#send-adaptive-cards-using-an-incoming-webhook) |
|08/10/2020|开始构建 Teams 应用和Visual Studio Toolkit。|[使用 Microsoft Teams Toolkit 和 Visual Studio 代码生成应用](toolkit/visual-studio-overview.md) |
...
|07/27/2020 | 将主动聊天机器人和消息 (公共预览版) |[使用 Microsoft Graph 在 Teams 中启用主动机器人安装和主动消息传递](graph-api/proactive-bots-and-messages/graph-proactive-bots-and-messages.md)|
...
|07/15/2020|为 Teams 创建虚拟助理|[Microsoft Teams 虚拟助手](samples/virtual-assistant.md)|
|07/14/2020|显示本机加载指示器文档|[显示本机加载指示器](tabs/how-to/create-tab-pages/content-page.md#show-a-native-loading-indicator)
|07/01/2020|开始使用"代码库"Visual Studio Teams Toolkit。|[使用 Microsoft Teams Toolkit 和 Visual Studio 代码生成应用](toolkit/visual-studio-code-overview.md) |
|07/01/2020|适用于 Teams Web 和桌面客户端的选项卡 GA 的单一登录|[单个Sign-On (SSO) ](tabs/how-to/authentication/auth-aad-sso.md)|
|06/05/2020| 清单架构更新到版本 1.7| [参考：Microsoft Teams 的清单架构](resources/schema/manifest-schema.md)|
| 05/20/2020 | 使用 Microsoft Graph API 的资源特定许可权限位于开发人员预览版中。 |[RSC (资源特定的) — 开发者预览版](graph-api/rsc/resource-specific-consent.md) |
...
| 10/31/2019 | 对话机器人和消息扩展文档已更新以反映 4.6 Bot Framework SDK。 有关 v3 SDK 的文档，请参阅"资源"部分。 | 所有机器人和消息扩展文档。 |
| 10/31/2019 | 新的文档结构和主要文章重构。 请通过创建 GitHub 问题报告任何死链接或 404。 | 全部！ |
| 9/13/2019 | 从基于操作的消息扩展安装请求自动程序。 | [使用邮件扩展启动操作](resources/messaging-extension-v3/create-extensions.md#request-to-install-your-conversational-bot)
...
| 05/20/2019 | 链接 (自定义 URL 预览) 。 | [链接展开](messaging-extensions/how-to/link-unfurling.md)|
| 05/06/2019 | 应用商店应用的应用程序认证计划。 | [应用程序认证](~/publishing/application-certification.md) |
...
| 09/24/2018 | Microsoft Graph 的通话和联机会议 API 已发布到 beta 版本，Teams 应用现在可以通过多种使用语音和视频的方式与用户进行交互。 | [通话和联机会议机器人](~/concepts/calls-and-meetings/registering-calling-bot.md)， [实时媒体](~/concepts/calls-and-meetings/real-time-media-concepts.md)概念， [注册](~/concepts/calls-and-meetings/registering-calling-bot.md)呼叫机器人， 调试 [和本地](~/concepts/calls-and-meetings/debugging-local-testing-calling-meeting-bots.md)测试， [应用程序](~/concepts/calls-and-meetings/requirements-considerations-application-hosted-media-bots.md)托管的媒体， [处理传入呼叫通知](~/concepts/calls-and-meetings/call-notifications.md) |
| 09/11/2018 | 选项卡配置页面现在高度明显提高。 | [选项卡设计](tabs/design/tabs.md) |
| 08/15/2018 | Teams 现在支持自适应卡片。|[Teams 中的自适应卡片操作](task-modules-and-cards/cards/cards-reference.md#adaptive-card) |
| 08/10/2018 | 已针对开发人员服务记录对 DevTools 的客户端开发者预览版。| [适用于 Microsoft Teams 桌面客户端的 DevTools](~/resources/dev-preview/developer-preview-tools.md)|
| 08/08/2018 | 邮件扩展现在支持多个命令。 此功能已开发者预览版，现已发布给所有用户。| [composeExtensions.commands](~/resources/schema/manifest-schema.md#composeextensionscommands)|
...
| 07/16/2018 | 在开发人员预览版中，为选项卡配置页分配了更多空间。 | [选项卡配置页高度明显高](tabs/design/tabs.md)|
| 07/12/2018 | 有关来宾访问的信息。 | [Microsoft Teams 中的来宾访问](https://docs.microsoft.com/microsoftteams/guest-access#guest-access-overview)|
| 06/07/2018 | 已添加 Microsoft Teams 租户应用目录的预发布信息。 | [发布 Microsoft Teams 应用](~/publishing/apps-publish.md)|
| 05/31/2018 | Teams 开发人员预览 (3.6) 更新为包括向群聊添加聊天机器人和选项卡的功能。 | [开发人员预览版、开发人员](~/resources/dev-preview/developer-preview-features.md)[预览架构中的功能](~/resources/schema/manifest-schema-dev-preview.md)|
| 05/29/2018 | 自适应卡片现在在 Teams 中的自适应 [卡片操作中受 Teams 支持](task-modules-and-cards/cards/cards-reference.md)。 |
| 05/29/2018 | 如果你使用的是开发人员 [预览版](~/resources/dev-preview/developer-preview-intro.md)，则机器人现在可以发送和接收文件。| [通过机器人发送和接收文件](~/concepts/bots/bots-files.md)，Microsoft [Teams 公共开发者预览版功能](~/resources/dev-preview/developer-preview-features.md)|
