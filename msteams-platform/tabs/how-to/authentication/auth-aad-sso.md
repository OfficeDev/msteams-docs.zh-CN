...
> **快速入门**  
>
> 开始使用选项卡 SSO 最简单的路径是使用 Teams 工具包Visual Studio Code。 有关详细信息，请参阅[SSO with Teams toolkit 和 Visual Studio Code for tabs](../../../toolkit/visual-studio-code-tab-sso.md)
...
> * 如果未在返回的访问令牌 (UPN) 用户主体名称，可以在 AAD 中添加它作为可选声明。 [](/azure/active-directory/develop/active-directory-optional-claims)
