...
description: 用于生成应用的 Teams 解决方案概述
ms.topic: overview
...
Teams 提供了这些和其他的功能，可为用户提供功能丰富的应用解决方案。 若要开发此应用，请执行以下操作：
...
在符合特定要求的环境中生成 Teams 应用。 甚至可以选择组合。
...
从设计到构建和分发 Teams 应用，你可以使用各种工具和服务。 开发流的示例：
