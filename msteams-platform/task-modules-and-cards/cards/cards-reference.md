...
> * Teams 平台支持 v1.3 或更早版本的自适应卡片功能，以实现其他功能，例如用户发送的卡片（基于搜索的消息扩展和链接展开）、选项卡和任务模块。
...
:::image type="content" source="~/assets/images/cards/adaptivecard.png" alt-text="自适应卡片示例":::
...
可以使用美元符号 ($) 和大括号在自适应卡片中传递动态值。有关详细信息，请参阅 [自适应卡片模板化](/adaptive-cards/templating/)。
...
:::image type="content" source="../../assets/images/Cards/hero.png" alt-text="主图卡":::
...
:::image type="content" source="../../assets/images/Cards/receipt.png" alt-text="收据卡":::
...
:::image type="content" source="../../assets/images/Cards/carousel.png" alt-text="轮播集合":::
...
:::image type="content" source="../../assets/images/Cards/list.png" alt-text="列表集合":::
