...
> [!TIP]
> 确保你已Teams代码打开Microsoft Visual Studio项目。
...
### <a name="scenario-1-customize-teams-app-name-for-different-environment"></a>方案 1：Teams环境自定义应用名称

可以将默认Teams`myapp(dev)`和暂存环境`dev``myapp(staging)`的应用名称设置为 `staging`。
