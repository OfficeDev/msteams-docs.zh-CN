...
为要盈利的应用生成登录Teams，请考虑以下方法。 请参阅最终用户购买体验中的 [登录页面示例](#end-user-purchasing-experience)。
...
1. 转到计划和 **定价** 页面，并指定你的发布者和产品/服务 ID。  (在合作伙伴中心中查找这些 ID（如果它们不可用的话）。) 
