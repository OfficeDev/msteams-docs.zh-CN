...
1.  [将你的应用发布到 Teams 应用商店](#publish-your-app)。
...
* 了解如何[Azure Active Directory (Azure AD) SSO](/azure/marketplace/azure-ad-saas) (单一) 客户购买和管理订阅。  (Azure AD SaaS 产品/服务Teams应用需要 SSO。) 
...
* 允许用户在你的登录页面上执行以下操作。 不要忘记考虑适用于用户的角色和权限 (例如，你可能希望仅允许订阅管理员搜索以下) ：
...
1. 转到计划和 **定价** 页面，并指定你的发布者和产品/服务 ID。  (在合作伙伴中心中查找这些 ID（如果你还没有现成的）。) 
...
1. 在 **"选择订阅计划**"对话框中，选择您需要的计划，然后选择"签出 **"。**  (注意：专用计划仅对提供优惠的组织中的用户可见。 这些计划用"特别优惠" :::image type="icon" source="~/assets/icons/special-icon.png"::: 图标表示。) 
