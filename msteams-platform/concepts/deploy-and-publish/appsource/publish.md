...
description: 介绍将应用提交到合作伙伴中心，以及将应用发布到 Microsoft Teams 应用商店 (AppSource) 。
ms.topic: overview
...
---
# <a name="publish-your-app-to-the-microsoft-teams-store"></a>将应用发布到应用商店Microsoft Teams应用商店
...
1. [查看Teams应用商店验证](~/concepts/deploy-and-publish/appsource/prepare/teams-store-validation-guidelines.md)指南，确保你的应用符合Teams应用商店标准。
