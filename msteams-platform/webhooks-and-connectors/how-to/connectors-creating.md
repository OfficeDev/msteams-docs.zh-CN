...
| `userObjectId` | 与启动连接器Office 365的用户对应的唯一 ID。 它必须是安全的。 此值可用于关联 Office 365 中的用户，该用户已在你的服务中设置配置。 |
...
#### <a name="example-of-manifestjson-with-connector"></a>连接器manifest.js上的示例
