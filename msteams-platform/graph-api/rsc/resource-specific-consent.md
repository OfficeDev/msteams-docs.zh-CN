...
description: 介绍 Teams 中的资源特定许可以及如何利用它。
...
|`applicationPermissions`|字符串数组|应用的 RSC 权限。 有关详细信息，请参阅[资源特定权限](resource-specific-consent.md#resource-specific-permissions)。|
