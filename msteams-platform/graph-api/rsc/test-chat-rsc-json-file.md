...
description: 如何使用 Postman 测试聊天中特定于资源Teams许可
...
---
# <a name="test-chat-rsc-postman-collection-for-json"></a><span data-ttu-id="a3bc0-104">测试聊天 RSC Postman 集合的 JSON</span><span class="sxs-lookup"><span data-stu-id="a3bc0-104">Test chat RSC Postman collection for JSON</span></span>
