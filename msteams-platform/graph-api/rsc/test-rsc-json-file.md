...
description: 如何使用 Postman 测试团队中特定于资源的同意
...
ms.locfileid: "48796141"
---
# <a name="test-rsc-postman-collection-json"></a><span data-ttu-id="eaeb3-104">测试 RSC Postman 集合 JSON</span><span class="sxs-lookup"><span data-stu-id="eaeb3-104">Test RSC Postman collection JSON</span></span>
