...
* 新版应用清单Teams两个附加设置 `supportsCalling` `supportsVideo`和 。 这些设置包含在清单架构[中用于Microsoft Teams](../../resources/schema/manifest-schema.md)。
...
你可以依赖管理员在应用程序门户授予Microsoft Azure[权限](https://portal.azure.com)。 更好的选择是使用 V2 `/adminconsent` 终结点为管理员提供Azure AD体验。 有关详细信息，请参阅 [有关构造管理员同意 URL 的说明](/graph/uth-v2-service#3-get-administrator-consent)。
