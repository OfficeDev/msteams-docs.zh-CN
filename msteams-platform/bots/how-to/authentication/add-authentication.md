...
1. <span data-ttu-id="8c36f-163">在 [**Azure 门户的**][azure-portal]左侧导航面板上，选择"**创建资源"。**</span><span class="sxs-lookup"><span data-stu-id="8c36f-163">In the [**Azure portal**][azure-portal], on the left navigation panel, select **Create a resource**.</span></span>
...
1. <span data-ttu-id="8c36f-204">将要求您提供以下信息：</span><span class="sxs-lookup"><span data-stu-id="8c36f-204">You'll be asked to provide the following information:</span></span>
   1. <span data-ttu-id="8c36f-205">**名称**。</span><span class="sxs-lookup"><span data-stu-id="8c36f-205">**Name**.</span></span> <span data-ttu-id="8c36f-206">输入应用程序的名称。</span><span class="sxs-lookup"><span data-stu-id="8c36f-206">Enter the name for the application.</span></span> <span data-ttu-id="8c36f-207">例如  *，BotTeamsIdentity*。</span><span class="sxs-lookup"><span data-stu-id="8c36f-207">An example could be  *BotTeamsIdentity*.</span></span> <span data-ttu-id="8c36f-208">请记住，该名称必须是唯一的。</span><span class="sxs-lookup"><span data-stu-id="8c36f-208">Remember that the name must be unique.</span></span>
...
### <a name="configure-the-identity-provider-connection-and-register-it-with-the-bot"></a><span data-ttu-id="8c36f-228">配置标识提供程序连接，然后向自动程序注册该连接</span><span class="sxs-lookup"><span data-stu-id="8c36f-228">Configure the identity provider connection and register it with the bot</span></span>
...
1. <span data-ttu-id="8c36f-240">如下所示完成表单：</span><span class="sxs-lookup"><span data-stu-id="8c36f-240">Complete the form as follows:</span></span>
    ...
    1. <span data-ttu-id="8c36f-251">**授予类型**。</span><span class="sxs-lookup"><span data-stu-id="8c36f-251">**Grant Type**.</span></span> <span data-ttu-id="8c36f-252">输入 `authorization_code` 。</span><span class="sxs-lookup"><span data-stu-id="8c36f-252">Enter `authorization_code`.</span></span>
...
1. <span data-ttu-id="8c36f-296">选择“**保存**”。</span><span class="sxs-lookup"><span data-stu-id="8c36f-296">Select **Save**.</span></span>
...
1. <span data-ttu-id="8c36f-314">克隆 [cs-auth-sample][teams-auth-bot-cs]。</span><span class="sxs-lookup"><span data-stu-id="8c36f-314">Clone [cs-auth-sample][teams-auth-bot-cs].</span></span>
...
1. <span data-ttu-id="8c36f-346">In Visual Studio *Solution Explorer* select and hold (or right-click) the project name.</span><span class="sxs-lookup"><span data-stu-id="8c36f-346">In Visual Studio *Solution Explorer* select and hold (or right-click) the project name.</span></span>
...
## <a name="test-the-bot-using-the-emulator"></a><span data-ttu-id="8c36f-368">使用仿真器测试机器人</span><span class="sxs-lookup"><span data-stu-id="8c36f-368">Test the bot using the Emulator</span></span>
...
### <a name="test-the-bot-locally"></a><span data-ttu-id="8c36f-385">在本地测试机器人</span><span class="sxs-lookup"><span data-stu-id="8c36f-385">Test the bot locally</span></span>
...
1. <span data-ttu-id="8c36f-401">根据用于模拟器的配置，你可以获取以下选项之一：</span><span class="sxs-lookup"><span data-stu-id="8c36f-401">Depending which configuration you used for the Emulator, you get one of the following:</span></span>
    ...
    <span data-ttu-id="8c36f-407">下图是登录后自动程序 UI 的一个示例：</span><span class="sxs-lookup"><span data-stu-id="8c36f-407">The following image is an example of the bot UI after you've logged in:</span></span>
...
1. <span data-ttu-id="8c36f-426">如果系统询问，请选择适用的用户帐户。</span><span class="sxs-lookup"><span data-stu-id="8c36f-426">If asked, select the applicable user's account.</span></span>
    ...
    ![已部署身份验证机器人登录](../../../assets/images/authentication/auth-bot-login-deployed.PNG)<span data-ttu-id="8c36f-429">.</span><span class="sxs-lookup"><span data-stu-id="8c36f-429">.</span></span>
...
<span data-ttu-id="8c36f-468">这将启动 ngrok 以侦听你指定的端口。</span><span class="sxs-lookup"><span data-stu-id="8c36f-468">This launches ngrok to listen on the port you specify.</span></span> <span data-ttu-id="8c36f-469">作为返回，它会为你提供一个外部可地址 URL，只要 ngrok 正在运行，该 URL 就有效。</span><span class="sxs-lookup"><span data-stu-id="8c36f-469">In return, it gives you an externally addressable URL, valid for as long as ngrok is running.</span></span> <span data-ttu-id="8c36f-470">下图是一个示例：</span><span class="sxs-lookup"><span data-stu-id="8c36f-470">The following image is an example:</span></span>
    ...
    ![teams 自动程序应用程序身份验证连接字符串 adv1](../../../assets/images/authentication/auth-bot-ngrok-start.PNG)<span data-ttu-id="8c36f-472">.</span><span class="sxs-lookup"><span data-stu-id="8c36f-472">.</span></span>
...
1. <span data-ttu-id="8c36f-477">要执行的最后一步是更新已部署机器人的消息终结点。</span><span class="sxs-lookup"><span data-stu-id="8c36f-477">One final step to perform is to update the messages endpoint of the deployed bot.</span></span> <span data-ttu-id="8c36f-478">在示例中，我们在 Azure 中部署了机器人。</span><span class="sxs-lookup"><span data-stu-id="8c36f-478">In the example, we deployed the bot in Azure.</span></span> <span data-ttu-id="8c36f-479">因此，让我们执行以下步骤：</span><span class="sxs-lookup"><span data-stu-id="8c36f-479">So \*\*let's perform these steps:</span></span>
    1. <span data-ttu-id="8c36f-480">在浏览器中导航到 [**Azure 门户**][azure-portal]。</span><span class="sxs-lookup"><span data-stu-id="8c36f-480">In your browser navigate to the [**Azure portal**][azure-portal].</span></span>
    1. <span data-ttu-id="8c36f-481">选择自动 **程序频道注册**。</span><span class="sxs-lookup"><span data-stu-id="8c36f-481">Select your **Bot Channel Registration**.</span></span>
    1. <span data-ttu-id="8c36f-482">在左侧面板中，选择 **"设置"。**</span><span class="sxs-lookup"><span data-stu-id="8c36f-482">In the left panel, select **Settings**.</span></span>
    1. <span data-ttu-id="8c36f-483">在右侧面板的"消息 **终结点** "框中，输入 ngrok URL，在我们的示例中为 `https://dea822bf.ngrok.io/api/messages` 。</span><span class="sxs-lookup"><span data-stu-id="8c36f-483">In the right panel, in the **Messaging endpoint** box, enter the ngrok URL, in our example, `https://dea822bf.ngrok.io/api/messages`.</span></span>
1. <span data-ttu-id="8c36f-484">在本地启动自动程序，例如，在Visual Studio模式下。</span><span class="sxs-lookup"><span data-stu-id="8c36f-484">Start your bot locally, for example in Visual Studio debug mode.</span></span>
1. <span data-ttu-id="8c36f-485">使用 Bot Framework 门户的测试 Web 聊天在本地运行时 **测试机器人**。</span><span class="sxs-lookup"><span data-stu-id="8c36f-485">Test the bot while running locally using the Bot Framework portal's **Test Web chat**.</span></span> <span data-ttu-id="8c36f-486">与仿真器一样，此测试不允许你访问Teams功能。</span><span class="sxs-lookup"><span data-stu-id="8c36f-486">Like the Emulator, this test doesn't allow you to access Teams-specific functionality.</span></span>
1. <span data-ttu-id="8c36f-487">在运行的终端窗口中，你可以看到自动程序与 Web 聊天客户端之间的 `ngrok` HTTP 流量。</span><span class="sxs-lookup"><span data-stu-id="8c36f-487">In the terminal window where `ngrok` is running you can see HTTP traffic between the bot and the web chat client.</span></span> <span data-ttu-id="8c36f-488">如果需要更详细的视图，请在浏览器窗口中输入从上一个终端 `http://127.0.0.1:4040` 窗口获取的视图。</span><span class="sxs-lookup"><span data-stu-id="8c36f-488">If you want a more detailed view, in a browser window enter `http://127.0.0.1:4040` you obtained from the previous terminal window.</span></span> <span data-ttu-id="8c36f-489">下图是一个示例：</span><span class="sxs-lookup"><span data-stu-id="8c36f-489">The following image is an example:</span></span>

    ![身份验证机器人团队 ngrok 测试](../../../assets/images/authentication/auth-bot-teams-ngrok-testing.png)<span data-ttu-id="8c36f-491">.</span><span class="sxs-lookup"><span data-stu-id="8c36f-491">.</span></span>

> [!NOTE]
> <span data-ttu-id="8c36f-492">如果停止并重新启动 ngrok，URL 将发生更改。</span><span class="sxs-lookup"><span data-stu-id="8c36f-492">If you stop and restart ngrok, the URL changes.</span></span> <span data-ttu-id="8c36f-493">若要在项目中使用 ngrok，并且根据您使用的功能，您必须更新所有 URL 引用。</span><span class="sxs-lookup"><span data-stu-id="8c36f-493">To use ngrok in your project, and depending on the capabilities you're using, you must update all URL references.</span></span>
 

## <a name="additional-information"></a><span data-ttu-id="8c36f-494">其他信息</span><span class="sxs-lookup"><span data-stu-id="8c36f-494">Additional information</span></span>

### <a name="teamsappmanifestmanifestjson"></a><span data-ttu-id="8c36f-495">TeamsAppManifest/manifest.js打开</span><span class="sxs-lookup"><span data-stu-id="8c36f-495">TeamsAppManifest/manifest.json</span></span>

<span data-ttu-id="8c36f-496">此清单包含用户Microsoft Teams自动程序连接时需要的信息。</span><span class="sxs-lookup"><span data-stu-id="8c36f-496">This manifest contains information needed by Microsoft Teams to connect with the bot.</span></span>  
...
<span data-ttu-id="8c36f-497">使用身份验证Teams与其他通道的行为稍有不同，如下所述。</span><span class="sxs-lookup"><span data-stu-id="8c36f-497">With authentication, Teams behaves slightly differently than other channels, as explained below.</span></span>

### <a name="handling-invoke-activity"></a><span data-ttu-id="8c36f-498">处理调用活动</span><span class="sxs-lookup"><span data-stu-id="8c36f-498">Handling Invoke Activity</span></span>

<span data-ttu-id="8c36f-499">将 **Invoke 活动** 发送到机器人，而不是其他频道使用的事件活动。</span><span class="sxs-lookup"><span data-stu-id="8c36f-499">An **Invoke Activity** is sent to the bot rather than the Event Activity used by other channels.</span></span>
<span data-ttu-id="8c36f-500">这是通过对 **ActivityHandler 进行子类化完成**。</span><span class="sxs-lookup"><span data-stu-id="8c36f-500">This is done by sub-classing the **ActivityHandler**.</span></span>

# <a name="cnet"></a>[<span data-ttu-id="8c36f-501">C#/.NET</span><span class="sxs-lookup"><span data-stu-id="8c36f-501">C#/.NET</span></span>](#tab/dotnet-sample)

<span data-ttu-id="8c36f-502">**Bots/DialogBot.cs**</span><span class="sxs-lookup"><span data-stu-id="8c36f-502">**Bots/DialogBot.cs**</span></span>

[!code-csharp[ActivityHandler](~/../botbuilder-samples/samples/csharp_dotnetcore/46.teams-auth/Bots/DialogBot.cs?range=19-51)]

<span data-ttu-id="8c36f-503">**Bots/TeamsBot.cs**</span><span class="sxs-lookup"><span data-stu-id="8c36f-503">**Bots/TeamsBot.cs**</span></span>

<span data-ttu-id="8c36f-504">如果使用 **OAuthPrompt，** 则必须将 Invoke 活动转发到对话框。 </span><span class="sxs-lookup"><span data-stu-id="8c36f-504">The *Invoke Activity* must be forwarded to the dialog if the **OAuthPrompt** is used.</span></span>

[!code-csharp[ActivityHandler](~/../botbuilder-samples/samples/csharp_dotnetcore/46.teams-auth/Bots/TeamsBot.cs?range=34-42)]

#### <a name="teamsactivityhandlercs"></a><span data-ttu-id="8c36f-505">TeamsActivityHandler.cs</span><span class="sxs-lookup"><span data-stu-id="8c36f-505">TeamsActivityHandler.cs</span></span>
...
# <a name="javascript"></a>[<span data-ttu-id="8c36f-506">JavaScript</span><span class="sxs-lookup"><span data-stu-id="8c36f-506">JavaScript</span></span>](#tab/node-js-dialog-sample)

<span data-ttu-id="8c36f-507">**bots/dialogBot.js**</span><span class="sxs-lookup"><span data-stu-id="8c36f-507">**bots/dialogBot.js**</span></span>

[!code-javascript[ActivityHandler](~/../botbuilder-samples/samples/javascript_nodejs/46.teams-auth/bots/dialogBot.js?range=4-46)]

<span data-ttu-id="8c36f-508">**bots/teamsBot.js**</span><span class="sxs-lookup"><span data-stu-id="8c36f-508">**bots/teamsBot.js**</span></span>

<span data-ttu-id="8c36f-509">如果使用 **OAuthPrompt，** 则必须将 Invoke 活动转发到对话框。 </span><span class="sxs-lookup"><span data-stu-id="8c36f-509">The *Invoke Activity* must be forwarded to the dialog if the **OAuthPrompt** is used.</span></span>

[!code-javascript[ActivityHandler](~/../botbuilder-samples/samples/javascript_nodejs/46.teams-auth/bots/teamsBot.js?range=4-33)]

<span data-ttu-id="8c36f-510">**dialogs/mainDialog.js**</span><span class="sxs-lookup"><span data-stu-id="8c36f-510">**dialogs/mainDialog.js**</span></span>

<span data-ttu-id="8c36f-511">在对话框步骤中， `beginDialog` 使用 启动 OAuth 提示，该提示要求用户登录。</span><span class="sxs-lookup"><span data-stu-id="8c36f-511">Within a dialog step, use `beginDialog` to start the OAuth prompt, which asks the user to sign in.</span></span>

- <span data-ttu-id="8c36f-512">如果用户已登录，这将生成令牌响应事件，而不会提示用户。</span><span class="sxs-lookup"><span data-stu-id="8c36f-512">If the user is already signed in, this will generate a token response event, without prompting the user.</span></span>
- <span data-ttu-id="8c36f-513">否则，将提示用户登录。</span><span class="sxs-lookup"><span data-stu-id="8c36f-513">Otherwise, this will prompt the user to sign in.</span></span> <span data-ttu-id="8c36f-514">Azure Bot 服务在用户尝试登录后发送令牌响应事件。</span><span class="sxs-lookup"><span data-stu-id="8c36f-514">The Azure Bot Service sends the token response event after the user attempts to sign in.</span></span>

[!code-javascript[AddOAuthPrompt](~/../botbuilder-samples/samples/javascript_nodejs/46.teams-auth/dialogs/mainDialog.js?range=50-52)]

<span data-ttu-id="8c36f-515">在下面的对话框步骤中，检查上一步的结果中是否存在令牌。</span><span class="sxs-lookup"><span data-stu-id="8c36f-515">Within the following dialog step, check for the presence of a token in the result from the previous step.</span></span> <span data-ttu-id="8c36f-516">如果不是 null，则用户已成功登录。</span><span class="sxs-lookup"><span data-stu-id="8c36f-516">If it is not null, the user successfully signed in.</span></span>

[!code-javascript[AddOAuthPrompt](~/../botbuilder-samples/samples/javascript_nodejs/46.teams-auth/dialogs/mainDialog.js?range=50-64)]

<span data-ttu-id="8c36f-517">**bots/logoutDialog.js**</span><span class="sxs-lookup"><span data-stu-id="8c36f-517">**bots/logoutDialog.js**</span></span>

[!code-javascript[allow-logout](~/../botbuilder-samples/samples/javascript_nodejs/46.teams-auth/dialogs/logoutDialog.js?range=31-42&highlight=7)]

# <a name="python"></a>[<span data-ttu-id="8c36f-518">Python</span><span class="sxs-lookup"><span data-stu-id="8c36f-518">Python</span></span>](#tab/python-sample)

<span data-ttu-id="8c36f-519">**bots/dialog_bot.py**</span><span class="sxs-lookup"><span data-stu-id="8c36f-519">**bots/dialog_bot.py**</span></span>

[!code-python[ActivityHandler](~/../botbuilder-samples/samples/python/46.teams-auth/bots/dialog_bot.py?range=10-42)]

<span data-ttu-id="8c36f-520">**bots/teams_bot.py**</span><span class="sxs-lookup"><span data-stu-id="8c36f-520">**bots/teams_bot.py**</span></span>

<span data-ttu-id="8c36f-521">如果使用 **OAuthPrompt，** 则必须将 Invoke 活动转发到对话框。 </span><span class="sxs-lookup"><span data-stu-id="8c36f-521">The *Invoke Activity* must be forwarded to the dialog if the **OAuthPrompt** is used.</span></span>

[!code-python[on_token_response_event](~/../botbuilder-samples/samples/python/46.teams-auth/bots/teams_bot.py?range=38-45)]

<span data-ttu-id="8c36f-522">**dialogs/main_dialog.py**</span><span class="sxs-lookup"><span data-stu-id="8c36f-522">**dialogs/main_dialog.py**</span></span>

<span data-ttu-id="8c36f-523">在对话框步骤中， `begin_dialog` 使用 启动 OAuth 提示，该提示要求用户登录。</span><span class="sxs-lookup"><span data-stu-id="8c36f-523">Within a dialog step, use `begin_dialog` to start the OAuth prompt, which asks the user to sign in.</span></span>

- <span data-ttu-id="8c36f-524">如果用户已登录，这将生成令牌响应事件，而不会提示用户。</span><span class="sxs-lookup"><span data-stu-id="8c36f-524">If the user is already signed in, this will generate a token response event, without prompting the user.</span></span>
- <span data-ttu-id="8c36f-525">否则，将提示用户登录。</span><span class="sxs-lookup"><span data-stu-id="8c36f-525">Otherwise, this will prompt the user to sign in.</span></span> <span data-ttu-id="8c36f-526">Azure Bot 服务在用户尝试登录后发送令牌响应事件。</span><span class="sxs-lookup"><span data-stu-id="8c36f-526">The Azure Bot Service sends the token response event after the user attempts to sign in.</span></span>

[!code-python[Add OAuthPrompt](~/../botbuilder-samples/samples/python/46.teams-auth/dialogs/main_dialog.py?range=48-49)]

<span data-ttu-id="8c36f-527">在下面的对话框步骤中，检查上一步的结果中是否存在令牌。</span><span class="sxs-lookup"><span data-stu-id="8c36f-527">Within the following dialog step, check for the presence of a token in the result from the previous step.</span></span> <span data-ttu-id="8c36f-528">如果不是 null，则用户已成功登录。</span><span class="sxs-lookup"><span data-stu-id="8c36f-528">If it is not null, the user successfully signed in.</span></span>

[!code-python[Add OAuthPrompt](~/../botbuilder-samples/samples/python/46.teams-auth/dialogs/main_dialog.py?range=51-61)]

<span data-ttu-id="8c36f-529">**dialogs/logout_dialog.py**</span><span class="sxs-lookup"><span data-stu-id="8c36f-529">**dialogs/logout_dialog.py**</span></span>
...
> [<span data-ttu-id="8c36f-530">了解如何通过 Azure Bot 服务添加身份验证</span><span class="sxs-lookup"><span data-stu-id="8c36f-530">Learn about adding authentication via Azure Bot Service</span></span>](https://aka.ms/azure-bot-add-authentication)
