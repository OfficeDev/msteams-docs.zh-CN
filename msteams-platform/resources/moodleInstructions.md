---
title: 安装 Moodle LMS
description: 如何安装和配置Microsoft Teams的 Moodle 集成应用
...
1. 在 **“设置”** 选项卡上`AppID``Key`添加之前复制的选项卡，然后选择 **“保存更改**”。 页面刷新后，可以看到新的“**选择连接”部分。**

1. 在 **“选择连接”方法** 中，选择标记为 **“默认**”的复选框，然后再次选择 **“保存更改** ”。

1. 页面刷新后，可以看到另一个新节 **管理员同意&其他信息**。
...
1. 在 **Bot Endpoint** 字段中粘贴刚复制的 URL，并将单词 *消息* 更改为 *Webhook*。 URL 必须如下所示： `https://botname.azurewebsites.net/api/webhook`
