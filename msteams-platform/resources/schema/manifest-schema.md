...
## <a name="version"></a><span data-ttu-id="3c1e9-118">version</span><span class="sxs-lookup"><span data-stu-id="3c1e9-118">version</span></span>
...
<span data-ttu-id="3c1e9-133">**必需** -对象</span><span class="sxs-lookup"><span data-stu-id="3c1e9-133">**Required** — object</span></span>
...
## <a name="description"></a><span data-ttu-id="3c1e9-170">说明</span><span class="sxs-lookup"><span data-stu-id="3c1e9-170">description</span></span>
...
|<span data-ttu-id="3c1e9-196">姓名</span><span class="sxs-lookup"><span data-stu-id="3c1e9-196">Name</span></span>| <span data-ttu-id="3c1e9-197">最大大小</span><span class="sxs-lookup"><span data-stu-id="3c1e9-197">Maximum size</span></span> | <span data-ttu-id="3c1e9-198">必需</span><span class="sxs-lookup"><span data-stu-id="3c1e9-198">Required</span></span> | <span data-ttu-id="3c1e9-199">说明</span><span class="sxs-lookup"><span data-stu-id="3c1e9-199">Description</span></span>|
|---|---|---|---|
...
## <a name="configurabletabs"></a><span data-ttu-id="3c1e9-231">configurableTabs</span><span class="sxs-lookup"><span data-stu-id="3c1e9-231">configurableTabs</span></span>
...
|---|---|---|---|---|
|`botId`|<span data-ttu-id="3c1e9-301">string</span><span class="sxs-lookup"><span data-stu-id="3c1e9-301">string</span></span>|<span data-ttu-id="3c1e9-302">64 个字符</span><span class="sxs-lookup"><span data-stu-id="3c1e9-302">64 characters</span></span>|<span data-ttu-id="3c1e9-303">✔</span><span class="sxs-lookup"><span data-stu-id="3c1e9-303">✔</span></span>|<span data-ttu-id="3c1e9-304">使用 Bot Framework 注册的自动程序的唯一 Microsoft 应用 ID。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-304">The unique Microsoft app ID for the bot as registered with the Bot Framework.</span></span> <span data-ttu-id="3c1e9-305">这可能与整体 [应用程序 ID](#id)很好。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-305">This may well be the same as the overall [app ID](#id).</span></span>|
...
|`items.commands`|<span data-ttu-id="3c1e9-334">对象数组</span><span class="sxs-lookup"><span data-stu-id="3c1e9-334">array of objects</span></span>|<span data-ttu-id="3c1e9-335">10 </span><span class="sxs-lookup"><span data-stu-id="3c1e9-335">10</span></span>|<span data-ttu-id="3c1e9-336">✔</span><span class="sxs-lookup"><span data-stu-id="3c1e9-336">✔</span></span>|<span data-ttu-id="3c1e9-337">自动程序支持的命令数组：</span><span class="sxs-lookup"><span data-stu-id="3c1e9-337">An array of commands the bot supports:</span></span><br><span data-ttu-id="3c1e9-338">`title`：自动程序命令名称（字符串，32）</span><span class="sxs-lookup"><span data-stu-id="3c1e9-338">`title`: the bot command name (string, 32)</span></span><br><span data-ttu-id="3c1e9-339">`description`：命令语法及其参数的简单描述或示例（字符串，128）</span><span class="sxs-lookup"><span data-stu-id="3c1e9-339">`description`: a simple description or example of the command syntax and its argument (string, 128)</span></span>|
...
|`messageHandlers.type`|<span data-ttu-id="3c1e9-406">string</span><span class="sxs-lookup"><span data-stu-id="3c1e9-406">string</span></span>|||<span data-ttu-id="3c1e9-407">消息处理程序的类型。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-407">The type of message handler.</span></span> <span data-ttu-id="3c1e9-408">必须是 `"link"`。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-408">Must be `"link"`.</span></span>|
...
|`fetchTask`|<span data-ttu-id="3c1e9-445">boolean</span><span class="sxs-lookup"><span data-stu-id="3c1e9-445">boolean</span></span>|||<span data-ttu-id="3c1e9-446">一个布尔值，指示是否应动态获取任务模块。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-446">A boolean value that indicates if it should fetch the task module dynamically.</span></span> <span data-ttu-id="3c1e9-447">默认值：**False**。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-447">Default: **false**.</span></span>|
...
|`parameters.choices`|<span data-ttu-id="3c1e9-483">对象数组</span><span class="sxs-lookup"><span data-stu-id="3c1e9-483">array of objects</span></span>|<span data-ttu-id="3c1e9-484">10项</span><span class="sxs-lookup"><span data-stu-id="3c1e9-484">10 items</span></span>||<span data-ttu-id="3c1e9-485">的选项选项 `choiceset` 。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-485">The choice options for the`choiceset`.</span></span> <span data-ttu-id="3c1e9-486">仅在时 `parameter.inputType` 使用 `choiceset` 。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-486">Use only when`parameter.inputType` is `choiceset`.</span></span>|
...
<span data-ttu-id="3c1e9-508">**可选**，但 **所需** 的除外</span><span class="sxs-lookup"><span data-stu-id="3c1e9-508">**Optional**, except **Required** where noted</span></span>
...
|<span data-ttu-id="3c1e9-522">姓名</span><span class="sxs-lookup"><span data-stu-id="3c1e9-522">Name</span></span>| <span data-ttu-id="3c1e9-523">类型</span><span class="sxs-lookup"><span data-stu-id="3c1e9-523">Type</span></span>| <span data-ttu-id="3c1e9-524">最大大小</span><span class="sxs-lookup"><span data-stu-id="3c1e9-524">Maximum size</span></span> | <span data-ttu-id="3c1e9-525">必需</span><span class="sxs-lookup"><span data-stu-id="3c1e9-525">Required</span></span> | <span data-ttu-id="3c1e9-526">说明</span><span class="sxs-lookup"><span data-stu-id="3c1e9-526">Description</span></span>|
|---|---|---|---|---|
|`id`|<span data-ttu-id="3c1e9-527">string</span><span class="sxs-lookup"><span data-stu-id="3c1e9-527">string</span></span>|<span data-ttu-id="3c1e9-528">36个字符</span><span class="sxs-lookup"><span data-stu-id="3c1e9-528">36 characters</span></span>|<span data-ttu-id="3c1e9-529">✔</span><span class="sxs-lookup"><span data-stu-id="3c1e9-529">✔</span></span>|<span data-ttu-id="3c1e9-530">应用程序的 AAD 应用程序 id。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-530">AAD application id of the app.</span></span> <span data-ttu-id="3c1e9-531">此 id 必须为 GUID。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-531">This id must be a GUID.</span></span>|
|`resource`|<span data-ttu-id="3c1e9-532">string</span><span class="sxs-lookup"><span data-stu-id="3c1e9-532">string</span></span>|<span data-ttu-id="3c1e9-533">2048 个字符</span><span class="sxs-lookup"><span data-stu-id="3c1e9-533">2048 characters</span></span>||<span data-ttu-id="3c1e9-534">用于获取 SSO 的身份验证令牌的应用程序的资源 url。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-534">Resource url of app for acquiring auth token for SSO.</span></span>|
|`applicationPermissions`|<span data-ttu-id="3c1e9-535">array of strings</span><span class="sxs-lookup"><span data-stu-id="3c1e9-535">array of strings</span></span>|<span data-ttu-id="3c1e9-536">128个字符</span><span class="sxs-lookup"><span data-stu-id="3c1e9-536">128 characters</span></span>||<span data-ttu-id="3c1e9-537">指定精确的 [资源特定许可](../../graph-api/rsc/resource-specific-consent.md#resource-specific-permissions)</span><span class="sxs-lookup"><span data-stu-id="3c1e9-537">Specify granular [resource specific consent](../../graph-api/rsc/resource-specific-consent.md#resource-specific-permissions)</span></span>|

## <a name="showloadingindicator"></a><span data-ttu-id="3c1e9-538">showLoadingIndicator</span><span class="sxs-lookup"><span data-stu-id="3c1e9-538">showLoadingIndicator</span></span>

<span data-ttu-id="3c1e9-539">**可选** -boolean</span><span class="sxs-lookup"><span data-stu-id="3c1e9-539">**Optional** — boolean</span></span>

<span data-ttu-id="3c1e9-540">指示在加载应用程序/选项卡时是否显示加载指示器。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-540">Indicate whether or not to show the loading indicator when an app/tab is loading.</span></span> <span data-ttu-id="3c1e9-541">默认值：**False**。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-541">Default: **false**.</span></span>
>[!NOTE]
><span data-ttu-id="3c1e9-542">如果您在应用程序清单中设置 "showLoadingIndicator： true"，然后要正确加载页面，则必须按照 [显示本机加载指示器](../../tabs/how-to/create-tab-pages/content-page.md#show-a-native-loading-indicator) 文档中所述的协议修改选项卡和任务模块的内容页面。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-542">If you set "showLoadingIndicator : true" in your app manifest, then for the page to load correctly, you must modify the content pages of your tabs and task modules as per the protocol described in [Show a native loading indicator](../../tabs/how-to/create-tab-pages/content-page.md#show-a-native-loading-indicator) document.</span></span>


## <a name="isfullscreen"></a><span data-ttu-id="3c1e9-543">isFullScreen</span><span class="sxs-lookup"><span data-stu-id="3c1e9-543">isFullScreen</span></span>

 <span data-ttu-id="3c1e9-544">**可选** -boolean</span><span class="sxs-lookup"><span data-stu-id="3c1e9-544">**Optional** — boolean</span></span>

<span data-ttu-id="3c1e9-545">使用或不使用 tab 头条指示个人应用程序的呈现位置。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-545">Indicate where a personal app is rendered with or without a tab-header bar.</span></span> <span data-ttu-id="3c1e9-546">默认值：**False**。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-546">Default: **false**.</span></span>

## <a name="activities"></a><span data-ttu-id="3c1e9-547">activities</span><span class="sxs-lookup"><span data-stu-id="3c1e9-547">activities</span></span>

<span data-ttu-id="3c1e9-548">**Optional** —对象</span><span class="sxs-lookup"><span data-stu-id="3c1e9-548">**Optional** — object</span></span>

<span data-ttu-id="3c1e9-549">定义您的应用程序将用于发布到用户活动源的属性。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-549">Define the properties your app will use to post to a user activity feed.</span></span>

|<span data-ttu-id="3c1e9-550">姓名</span><span class="sxs-lookup"><span data-stu-id="3c1e9-550">Name</span></span>| <span data-ttu-id="3c1e9-551">类型</span><span class="sxs-lookup"><span data-stu-id="3c1e9-551">Type</span></span>| <span data-ttu-id="3c1e9-552">最大大小</span><span class="sxs-lookup"><span data-stu-id="3c1e9-552">Maximum size</span></span> | <span data-ttu-id="3c1e9-553">必需</span><span class="sxs-lookup"><span data-stu-id="3c1e9-553">Required</span></span> | <span data-ttu-id="3c1e9-554">说明</span><span class="sxs-lookup"><span data-stu-id="3c1e9-554">Description</span></span>|
|---|---|---|---|---|
|`activityTypes`|<span data-ttu-id="3c1e9-555">对象数组</span><span class="sxs-lookup"><span data-stu-id="3c1e9-555">array of Objects</span></span>|<span data-ttu-id="3c1e9-556">128项</span><span class="sxs-lookup"><span data-stu-id="3c1e9-556">128 items</span></span>| | <span data-ttu-id="3c1e9-557">指定您的应用程序可以发布到用户活动源的活动类型。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-557">Specify the types of activities that your app can post to a users activity feed.</span></span>|

### <a name="activitiesactivitytypes"></a><span data-ttu-id="3c1e9-558">activityTypes</span><span class="sxs-lookup"><span data-stu-id="3c1e9-558">activities.activityTypes</span></span>

|<span data-ttu-id="3c1e9-559">姓名</span><span class="sxs-lookup"><span data-stu-id="3c1e9-559">Name</span></span>| <span data-ttu-id="3c1e9-560">类型</span><span class="sxs-lookup"><span data-stu-id="3c1e9-560">Type</span></span>| <span data-ttu-id="3c1e9-561">最大大小</span><span class="sxs-lookup"><span data-stu-id="3c1e9-561">Maximum size</span></span> | <span data-ttu-id="3c1e9-562">必需</span><span class="sxs-lookup"><span data-stu-id="3c1e9-562">Required</span></span> | <span data-ttu-id="3c1e9-563">说明</span><span class="sxs-lookup"><span data-stu-id="3c1e9-563">Description</span></span>|
|---|---|---|---|---|
|`type`|<span data-ttu-id="3c1e9-564">string</span><span class="sxs-lookup"><span data-stu-id="3c1e9-564">string</span></span>|<span data-ttu-id="3c1e9-565">32个字符</span><span class="sxs-lookup"><span data-stu-id="3c1e9-565">32 characters</span></span>|<span data-ttu-id="3c1e9-566">✔</span><span class="sxs-lookup"><span data-stu-id="3c1e9-566">✔</span></span>|<span data-ttu-id="3c1e9-567">通知类型。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-567">The notification type.</span></span> <span data-ttu-id="3c1e9-568">*请参阅下文*。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-568">*See below*.</span></span>|
|`description`|<span data-ttu-id="3c1e9-569">string</span><span class="sxs-lookup"><span data-stu-id="3c1e9-569">string</span></span>|<span data-ttu-id="3c1e9-570">128个字符</span><span class="sxs-lookup"><span data-stu-id="3c1e9-570">128 characters</span></span>|<span data-ttu-id="3c1e9-571">✔</span><span class="sxs-lookup"><span data-stu-id="3c1e9-571">✔</span></span>|<span data-ttu-id="3c1e9-572">通知的简短说明。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-572">A brief description of the notification.</span></span> <span data-ttu-id="3c1e9-573">*请参阅下文*。</span><span class="sxs-lookup"><span data-stu-id="3c1e9-573">*See below*.</span></span>|
|`templateText`|<span data-ttu-id="3c1e9-574">string</span><span class="sxs-lookup"><span data-stu-id="3c1e9-574">string</span></span>|<span data-ttu-id="3c1e9-575">128个字符</span><span class="sxs-lookup"><span data-stu-id="3c1e9-575">128 characters</span></span>|<span data-ttu-id="3c1e9-576">✔</span><span class="sxs-lookup"><span data-stu-id="3c1e9-576">✔</span></span>|<span data-ttu-id="3c1e9-577">Ex： "{主角} 为您创建任务 {taskId}"</span><span class="sxs-lookup"><span data-stu-id="3c1e9-577">Ex: "{actor} created task {taskId} for you"</span></span>|
