...
在本教程中，你将生成基本频道 *选项卡 (也称为* 组选项卡 *) ，* 它是团队频道或聊天的全屏页面。 与个人选项卡不同，用户可以配置此类选项卡的一些 (例如，重命名选项卡，以便对其频道) 。
...
通过生成频道选项卡，可以使此信息更易于查找，这将消除要求所有人安装应用的负担。 相反，一个用户可以在频道中添加选项卡或聊天，以适合整个组。
